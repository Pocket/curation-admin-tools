...
REACT_APP_PROSPECT_API_ENDPOINT=http://localhost:4026/graphql
```
...
REACT_APP_PROSPECT_API_ENDPOINT=https://prospect-api.getpocket.dev/admin
```
...
npm run api:generate-curated-corpus-types

# same for Prospect API
npm run api:generate-prospect-types
```
