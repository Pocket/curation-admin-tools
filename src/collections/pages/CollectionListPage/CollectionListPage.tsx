...
export const CollectionListPage = (): JSX.Element => {
  ...
  const tabs: CustomTabType[] = [
    ...
    {
      label: 'Review',
      pathname: '/collections/collections/review/',
      count: dataReview?.searchCollections.pagination.totalResults,
      hasLink: true,
    },
    {
      label: 'Published',
      pathname: '/collections/collections/published/',
      count: dataPublished?.searchCollections.pagination.totalResults,
      hasLink: true,
    },
    {
      label: 'Archived',
      pathname: '/collections/collections/archived/',
    ...
    <>
      <Box display="flex">
        ...
        <Box alignSelf="center">
          <Button
            component={Link}
            to="/collections/collections/add/"
            buttonType="hollow"
          >
            Add collection
          </Button>
      ...
      <TabPanel value={value} index="/collections/collections/drafts/">
      ...
      <TabPanel value={value} index="/collections/collections/review/">
        {!dataReview && (
      ...
      <TabPanel value={value} index="/collections/collections/published/">
        {!dataPublished && (
          <HandleApiResponse
      ...
      <TabPanel value={value} index="/collections/collections/archived/">
        {!dataArchived && (
