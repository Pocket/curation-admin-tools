...
> = (props): JSX.Element => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      [RemovalReason.HeadlineQuality]: false,
      [RemovalReason.Inappropriate]: false,
      [RemovalReason.Niche]: false,
      [RemovalReason.NoImage]: false,
      [RemovalReason.OneSided]: false,
      [RemovalReason.Outdated]: false,
      [RemovalReason.Paywall]: false,
      [RemovalReason.PoliticalOpinion]: false,
      [RemovalReason.Publisher]: false,
      [RemovalReason.Redundant]: false,
      [RemovalReason.SetSimilarity]: false,
      [RemovalReason.TimeSensitive]: false,
      [RemovalReason.Topic]: false,
      removalReason: '',
      otherReason: '',
    },
